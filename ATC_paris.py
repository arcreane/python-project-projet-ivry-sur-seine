...
class Ui_ATC_paris(object):
    ...
    def retranslateUi(self, ATC_paris):
        ...
        self.txt_nord.setText(QCoreApplication.translate("ATC_paris", u"0", None))
        self.txt_est.setText(QCoreApplication.translate("ATC_paris", u"90", None))
        self.txt_sud.setText(QCoreApplication.translate("ATC_paris", u"180", None))
        self.txt_ouest.setText(QCoreApplication.translate("ATC_paris", u"270", None))
