...
################################################################################
## Form generated from reading UI file 'ATC_paris.ui'
##
...
"")
        ...
        self.txt_direction = QLabel(self.frame_stat)
        self.txt_direction.setObjectName(u"txt_direction")
        self.txt_direction.setGeometry(QRect(100, 20, 49, 16))
        self.txt_direction.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.txt_direction_variable = QLabel(self.frame_stat)
        self.txt_direction_variable.setObjectName(u"txt_direction_variable")
        self.txt_direction_variable.setGeometry(QRect(100, 40, 49, 16))
        self.txt_direction_variable.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.txt_altitude_variable = QLabel(self.frame_stat)
        self.txt_altitude_variable.setObjectName(u"txt_altitude_variable")
        self.txt_altitude_variable.setGeometry(QRect(100, 220, 49, 16))
        self.txt_altitude_variable.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.txt_vitessev = QLabel(self.frame_stat)
        self.txt_vitessev.setObjectName(u"txt_vitessev")
        self.txt_vitessev.setGeometry(QRect(80, 320, 101, 16))
        self.txt_vitessev.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.txt_vitesse_variable = QLabel(self.frame_stat)
        self.txt_vitesse_variable.setObjectName(u"txt_vitesse_variable")
        self.txt_vitesse_variable.setGeometry(QRect(100, 280, 49, 16))
        self.txt_vitesse_variable.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.txt_vitessev_variable = QLabel(self.frame_stat)
        self.txt_vitessev_variable.setObjectName(u"txt_vitessev_variable")
        self.txt_vitessev_variable.setGeometry(QRect(90, 340, 81, 16))
        self.txt_vitessev_variable.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.menubar = QMenuBar(ATC_paris)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 900, 33))
        ATC_paris.setMenuBar(self.menubar)
    ...
    def retranslateUi(self, ATC_paris):
        ...
        self.label_4.setText(QCoreApplication.translate("ATC_paris", u"D\u00e9part", None))
        self.label_9.setText(QCoreApplication.translate("ATC_paris", u"To", None))
        self.label_10.setText(QCoreApplication.translate("ATC_paris", u"Arriv\u00e9", None))
        self.label_11.setText(QCoreApplication.translate("ATC_paris", u"Type", None))
        self.label_12.setText(QCoreApplication.translate("ATC_paris", u"B777", None))
        self.label_13.setText(QCoreApplication.translate("ATC_paris", u"Immat", None))
        self.label_14.setText(QCoreApplication.translate("ATC_paris", u"F-GSPZ", None))
        self.label_15.setText(QCoreApplication.translate("ATC_paris", u"Turb", None))
        self.label_16.setText(QCoreApplication.translate("ATC_paris", u"Beaucoup", None))
        self.label_17.setText(QCoreApplication.translate("ATC_paris", u"Pax", None))
        self.label_18.setText(QCoreApplication.translate("ATC_paris", u"312", None))
        self.label_19.setText(QCoreApplication.translate("ATC_paris", u"Level", None))
        ...
        self.txt_direction.setText(QCoreApplication.translate("ATC_paris", u"Heading :", None))
        self.txt_direction_variable.setText(QCoreApplication.translate("ATC_paris", u"XXX", None))
        self.img_cercle.setText("")
        self.txt_nord.setText(QCoreApplication.translate("ATC_paris", u"N", None))
        self.txt_est.setText(QCoreApplication.translate("ATC_paris", u"E", None))
        self.txt_sud.setText(QCoreApplication.translate("ATC_paris", u"S", None))
        self.txt_ouest.setText(QCoreApplication.translate("ATC_paris", u"O", None))
        self.txt_altitude.setText(QCoreApplication.translate("ATC_paris", u"Altitude :", None))
        self.txt_altitude_variable.setText(QCoreApplication.translate("ATC_paris", u"XXXXX ft", None))
        self.txt_vitesse.setText(QCoreApplication.translate("ATC_paris", u"Vitesse :", None))
        self.txt_vitessev.setText(QCoreApplication.translate("ATC_paris", u"Vitesse Verticale :", None))
        self.txt_vitesse_variable.setText(QCoreApplication.translate("ATC_paris", u"XXX kts", None))
        self.txt_vitessev_variable.setText(QCoreApplication.translate("ATC_paris", u"+-XXXX ft/min", None))
...
if __name__ == "__main__":   # test pour ouvrir la fenetre
    ...
    ui = Ui_ATC_paris()  # instancie ton interface
