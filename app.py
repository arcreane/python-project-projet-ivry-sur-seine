...
class ATC_parislfff(QMainWindow, Ui_ATC_paris):       #def de la page paris
    ...
    def initiate_landing_sequence(self):
        ...
        target_airport = None
        min_dist_sq = self.LANDING_THRESHOLD_PIXELS ** 2
        ...
        if target_airport:
            ...
            self.label_5.set_landing_target(callsign, target_pos_qpointf, self.LANDING_THRESHOLD_PIXELS,self.REMOVAL_THRESHOLD_PIXELS)
            ...
            self.statusBar().showMessage(
                f"L'avion n'est pas en zone d'approche finale autorisée ({self.LANDING_THRESHOLD_PIXELS}px).", 3000)
...
class ATC_marseillelfmm(QMainWindow, Ui_ATC_marseille):  #def de la page paris
    ...
    def _load_airports_on_map(self):
        CODES_AUTORISES = ["MPL", "MRS","NCE","LYS"]
