...
################################################################################
## Form generated from reading UI file 'ATC_bordeaux.ui'
##
...
class Ui_ATC_bordeaux(object):
    def setupUi(self, ATC_bordeaux):
        if not ATC_bordeaux.objectName():
            ATC_bordeaux.setObjectName(u"ATC_bordeaux")
        ATC_bordeaux.resize(1136, 642)
        self.centralwidget = QWidget(ATC_bordeaux)
        ...
        self.label_6.setGeometry(QRect(50, -300, 831, 791))
        self.label_6.setPixmap(QPixmap(u"image/MAP_france_2.png"))
        self.frame = QFrame(self.frame_carte)
        self.frame.setObjectName(u"frame")
        self.frame.setGeometry(QRect(110, 30, 391, 401))
        self.frame.setStyleSheet(u"background-color: rgba(255,128,0, 10);\n"
"")
        ...
        self.line_12 = QFrame(self.frame_7)
        ...
        self.frame_12 = QFrame(self.frame_strip)
        ...
        ATC_bordeaux.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(ATC_bordeaux)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 1136, 33))
        ATC_bordeaux.setMenuBar(self.menubar)
        self.statusbar = QStatusBar(ATC_bordeaux)
        self.statusbar.setObjectName(u"statusbar")
        ATC_bordeaux.setStatusBar(self.statusbar)

        self.retranslateUi(ATC_bordeaux)

        QMetaObject.connectSlotsByName(ATC_bordeaux)
    # setupUi

    def retranslateUi(self, ATC_bordeaux):
        ATC_bordeaux.setWindowTitle(QCoreApplication.translate("ATC_bordeaux", u"ATC_bordeaux", None))
        self.label_6.setText("")
        self.txt_titre.setText(QCoreApplication.translate("ATC_bordeaux", u"Bordeaux LFBB", None))
        self.txt_heading.setText(QCoreApplication.translate("ATC_bordeaux", u"Heading :", None))
        self.img_cercle.setText("")
        self.txt_nord.setText(QCoreApplication.translate("ATC_bordeaux", u"N", None))
        self.txt_est.setText(QCoreApplication.translate("ATC_bordeaux", u"E", None))
        self.txt_sud.setText(QCoreApplication.translate("ATC_bordeaux", u"S", None))
        self.txt_ouest.setText(QCoreApplication.translate("ATC_bordeaux", u"O", None))
        self.txt_altitude.setText(QCoreApplication.translate("ATC_bordeaux", u"Altitude :", None))
        self.unit_altitude.setText(QCoreApplication.translate("ATC_bordeaux", u" ft", None))
        self.txt_vitesse.setText(QCoreApplication.translate("ATC_bordeaux", u"Vitesse :", None))
        self.txt_vitesse_verticale.setText(QCoreApplication.translate("ATC_bordeaux", u"Vitesse Verticale :", None))
        self.unit_vitesse.setText(QCoreApplication.translate("ATC_bordeaux", u"kts", None))
        self.unit_vitesse_verticale.setText(QCoreApplication.translate("ATC_bordeaux", u" ft/min", None))
        self.img_icon_avion.setText("")
        self.unit_heading.setText(QCoreApplication.translate("ATC_bordeaux", u"\u00b0", None))
        self.btn_apply.setText(QCoreApplication.translate("ATC_bordeaux", u"Apply", None))
        self.btn_accueil.setText("")
        self.btn_parametres.setText("")
        self.btn_sortie.setText("")
        self.label.setText(QCoreApplication.translate("ATC_bordeaux", u"Callsign", None))
        self.label_2.setText(QCoreApplication.translate("ATC_bordeaux", u"AFR 002 Heavy", None))
        self.label_3.setText(QCoreApplication.translate("ATC_bordeaux", u"From", None))
        self.label_4.setText(QCoreApplication.translate("ATC_bordeaux", u"D\u00e9part", None))
        self.label_9.setText(QCoreApplication.translate("ATC_bordeaux", u"To", None))
        self.label_10.setText(QCoreApplication.translate("ATC_bordeaux", u"Arriv\u00e9", None))
        self.label_11.setText(QCoreApplication.translate("ATC_bordeaux", u"Type", None))
        self.label_12.setText(QCoreApplication.translate("ATC_bordeaux", u"B777", None))
        self.label_13.setText(QCoreApplication.translate("ATC_bordeaux", u"Immat", None))
        self.label_14.setText(QCoreApplication.translate("ATC_bordeaux", u"F-GSPZ", None))
        self.label_15.setText(QCoreApplication.translate("ATC_bordeaux", u"Turb", None))
        self.label_16.setText(QCoreApplication.translate("ATC_bordeaux", u"Beaucoup", None))
        self.label_17.setText(QCoreApplication.translate("ATC_bordeaux", u"Pax", None))
        self.label_18.setText(QCoreApplication.translate("ATC_bordeaux", u"312", None))
        self.label_19.setText(QCoreApplication.translate("ATC_bordeaux", u"Level", None))
        self.label_20.setText(QCoreApplication.translate("ATC_bordeaux", u"360", None))
        self.label_21.setText(QCoreApplication.translate("ATC_bordeaux", u"Sqwk", None))
        self.label_22.setText(QCoreApplication.translate("ATC_bordeaux", u"1000", None))
    # retranslateUi
