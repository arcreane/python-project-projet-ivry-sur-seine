...
class Ui_ATC_bordeaux(object):
    def setupUi(self, ATC_bordeaux):
        ...
        ATC_bordeaux.resize(900, 648)
        ATC_bordeaux.setMinimumSize(QSize(900, 620))

        self.centralwidget = QWidget(ATC_bordeaux)  # ligne de création
        ...
        self.label_5.set_map_image(u"image/MAP_bordeaux.png")
        """ 
    ...
    def retranslateUi(self, ATC_bordeaux):
        ATC_bordeaux.setWindowTitle(QCoreApplication.translate("ATC_bordeaux", u"MainWindow", None))
        ...
        '''
        self.txt_titre.setText(QCoreApplication.translate("ATC_bordeaux", u"Bordeaux LFFF", None))
        self.txt_heading.setText(QCoreApplication.translate("ATC_bordeaux", u"Heading :", None))
        self.img_cercle.setText("")
        self.txt_nord.setText(QCoreApplication.translate("ATC_bordeaux", u"0", None))
        self.txt_est.setText(QCoreApplication.translate("ATC_bordeaux", u"90", None))
        self.txt_sud.setText(QCoreApplication.translate("ATC_bordeaux", u"180", None))
        self.txt_ouest.setText(QCoreApplication.translate("ATC_bordeaux", u"270", None))
