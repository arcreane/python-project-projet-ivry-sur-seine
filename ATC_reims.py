...
class Ui_ATC_reims(object):
    ...
    def retranslateUi(self, ATC_reims):
        ...
        self.txt_est.setText(QCoreApplication.translate("ATC_reims", u"90", None))
        self.txt_sud.setText(QCoreApplication.translate("ATC_reims", u"180", None))
        self.txt_ouest.setText(QCoreApplication.translate("ATC_reims", u"270", None))
