...
class Ui_ATC_marseille(object):
    def setupUi(self, ATC_marseille):
        ...
        ATC_marseille.resize(899, 640)
        self.centralwidget = QWidget(ATC_marseille)
        ...
        self.label_6.setGeometry(QRect(-310, -330, 831, 791))
        self.label_6.setPixmap(QPixmap(u"image/MAP_france_2.png"))
        self.frame = QFrame(self.frame_carte)
        self.frame.setObjectName(u"frame")
        self.frame.setGeometry(QRect(109, 20, 421, 401))
        self.frame.setStyleSheet(u"background-color: rgba(255,255,0, 10);\n"
"")
    ...
    def retranslateUi(self, ATC_marseille):
        ATC_marseille.setWindowTitle(QCoreApplication.translate("ATC_marseille", u"ATC_marseille", None))
        self.label_6.setText("")
        self.txt_titre.setText(QCoreApplication.translate("ATC_marseille", u"Paris LFFF", None))
