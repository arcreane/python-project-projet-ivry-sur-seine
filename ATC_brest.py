...
################################################################################
## Form generated from reading UI file 'ATC_brest.ui'
##
...
class Ui_ATC_brest(object):
    def setupUi(self, ATC_brest):
        if not ATC_brest.objectName():
            ATC_brest.setObjectName(u"ATC_brest")
        ATC_brest.resize(891, 640)
        self.centralwidget = QWidget(ATC_brest)
        ...
        self.label_5.setGeometry(QRect(160, -50, 871, 781))
        self.label_5.setPixmap(QPixmap(u"image/MAP_france_2.png"))
        self.frame_10 = QFrame(self.frame_carte)
        self.frame_10.setObjectName(u"frame_10")
        self.frame_10.setGeometry(QRect(-60, 0, 481, 451))
        self.frame_10.setStyleSheet(u"background-color: rgba(0,100,0, 10);\n"
"")
        ...
        ATC_brest.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(ATC_brest)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 891, 33))
        ATC_brest.setMenuBar(self.menubar)
        self.statusbar = QStatusBar(ATC_brest)
        self.statusbar.setObjectName(u"statusbar")
        ATC_brest.setStatusBar(self.statusbar)

        self.retranslateUi(ATC_brest)

        QMetaObject.connectSlotsByName(ATC_brest)
    # setupUi

    def retranslateUi(self, ATC_brest):
        ATC_brest.setWindowTitle(QCoreApplication.translate("ATC_brest", u"ATC_brest", None))
        self.label_5.setText("")
        self.txt_titre.setText(QCoreApplication.translate("ATC_brest", u"Brest LFRR", None))
        ...
        self.txt_vitesse_verticale.setText(QCoreApplication.translate("ATC_brest", u"Vitesse Verticale :", None))
        self.unit_vitesse.setText(QCoreApplication.translate("ATC_brest", u"kts", None))
        self.unit_vitesse_verticale.setText(QCoreApplication.translate("ATC_brest", u" ft/min", None))
